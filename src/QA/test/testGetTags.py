...
class TestTags(unittest.TestCase):
    ...
    def test_success(self):
        pass
#         # Attempt to insert
#         responseBody = self.user.get_tag_list()
#           
#         # Ensure insert
...
#                           msg='test_float assert#1 has failed.') 
    ...
    def test_string(self):
        pass
#         # String INSERT value.
#         responseBody = self.user.get_tag_list("';:.>,</?]}[{!@#$%^&*()-_=+|\"")
#          
#         self.assertEqual(responseBody['err']['err'], 'user does not exist',
#                           msg='test_string assert#1 has failed.')
    ...
    def test_array(self):
        pass
#         # Array INSERT value.
#         responseBody = self.user.get_tag_list(['hodl', 666, [.6, 0], {}])
#              
#         self.assertEqual(responseBody['err']['err'], 'User ID required',
...
#     suite.addTest(TestTags('test_success'))
#                       
#     suite.addTest(TestTags('test_missing'))
#     suite.addTest(TestTags('test_null'))
#     suite.addTest(TestTags('test_int'))
#     suite.addTest(TestTags('test_float'))
#     suite.addTest(TestTags('test_string'))
#     suite.addTest(TestTags('test_array'))
